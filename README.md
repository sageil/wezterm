...
> [!IMPORTANT]
> Linux, Windows, and Intel-base Macs users: Remove the following lines in [wezterm.lua](https://github.com/sageil/wezterm/blob/7864a84ef040591a53c77c2fa5abf045a962d4c8/wezterm.lua#L24C1-L26C2) and adjust the `$PATH` accordingly.
``` lua
